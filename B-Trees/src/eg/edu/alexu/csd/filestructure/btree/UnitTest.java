...
public class UnitTest {
	...
	public void testindexWebPage() {
		...
		try {
			...
			/**for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.getId());
			}*/
	...
	public void testindexWebDirectoryComplex() {
		...
		try {
			searchEngine.indexDirectory("res");
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7697605", 1), new SearchResult("7698150", 1)});
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("ThE");
			for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
	...
	public void testDeleteWebPageSimple() {
		...
		try {
			...
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7702780", 1), new SearchResult("7702788", 1)});
			List<ISearchResult> actual = searchEngine.searchByWordWithRanking("soso");
			/**for (ISearchResult searchRes : actual) {
				System.out.println(searchRes.toString());
			}
			Collections.sort(actual, new Comparator<ISearchResult>() {
	...
	public void testsearchByMultipleWordWithRanking() {
		...
		try {
			searchEngine.indexDirectory("res");
			List<ISearchResult> expected = Arrays.asList(new SearchResult[]{new SearchResult("7697611", 1), new SearchResult("7697675", 1)});
